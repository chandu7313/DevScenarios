  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <header className="flex-shrink-0 bg-white border-b border-gray-200 px-4 py-3">
        ...
        <div className="mt-2">
          <span className="inline-flex items-center gap-1.5 text-xs text-gray-500 bg-gray-100 px-2.5 py-1 rounded-full max-w-full">
            <span>📚</span>
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-4 py-4 bg-gray-50 space-y-1 scroll-smooth
      ...
      >
        {messages.length === 0 ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center py-8 gap-4">
            ...
            <div>
              <p className="text-lg font-semibold text-gray-900">Ask me anything</p>
            ...
            <div className="w-full max-w-sm space-y-2 mt-2">
              {SUGGESTED_QUESTIONS.map((q) => (
                <button
                  ...
                  className="w-full flex items-center justify-between bg-white border border-gray-200 rounded-xl px-4 py-3 text-left hover:border-indigo-300 hover:bg-indigo-50 transition-all group"
                >
                  <span className="text-sm text-gray-700 group-hover:text-indigo-700 leading-snug">{q}</span>
            ...
            {messages.map((msg: Message, idx: number) => {
              ...
              return (
                <div key={msg.id} className={`flex flex-col ${isUser ? 'items-end' : 'items-start'} mb-4`}>
                  <span className={`text-[10px] font-medium mb-1 ${isUser ? 'text-gray-400' : 'text-indigo-500'}`}>
                    {isUser ? 'You' : 'AI'}
                  </span>
                  <div
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-4 py-3">
        <div className="flex items-end gap-2">
          <textarea
            ...
            className="flex-1 resize-none bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800
        ...
        <div className="flex items-center justify-between mt-2">
          <span className="text-[10px] text-gray-400">Powered by Gemini 1.5 Flash</span>
          {charCount > 200 && (
